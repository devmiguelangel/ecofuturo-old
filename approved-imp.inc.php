...
if(isset($_GET['ide'])){
	...
	$sqlId = 'SELECT no_emision FROM s_'.strtolower($product).'_em_cabecera WHERE id_emision = "'.$ide.'" ;';
...
?>
<h3 class="h3">Solicitud de Aprobación de Pólizas</h3>
<table class="rp-link-container">
	<tr>
        ...
        <td style="width:40%; border-bottom:1px solid #CECECE;">
        	<input type="hidden" id="flag" name="flag" value="<?=md5('IM');?>">
		</td>
    </tr>
</table>
...
?>
            ...
            <input type="text" id="frp-nc" name="frp-nc" value="<?=$nEm;?>" autocomplete="off">
...
?>
            ...
            <label class="lbl-cb"><input type="radio" id="frp-canceled-both" name="frp-canceled-p" value="" checked>Ninguno</label>-->
