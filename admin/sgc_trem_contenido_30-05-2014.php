		...
		<div class="da-panel collapsible">
			<div class="da-panel-header">
				<span class="da-panel-title">
					...
					<b>'.$regief['nombre'].'</b> - Contenido Todo Riesgo Equipo Movil
				</span>
			</div>
	...
	if(isset($_POST['accionGuardar'])) {
		...
		if($errFlag) {
			...
			mostrar_editar_contenido_todoriesequimovil($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion, $errArr);
			   ...
			   $update.="html='".$contenido."' WHERE id_home = '".$idhome."' and id_ef ='".$id_ef."' and producto='TRM' LIMIT 1;";
		  ...
		  <div class="da-panel">
			  <div class="da-panel-header">
				  <span class="da-panel-title">
					  ...
					  Actualizar Contenido Todo Riesgo Equipo Movil
				  </span>
			  </div>
			  <div class="da-panel-content">
