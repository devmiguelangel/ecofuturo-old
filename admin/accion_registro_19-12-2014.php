  ...
  if($_POST['opcion']=='certmedico'){
	 ...
	 if($num_regi==0){
	  ...
	  if($row_cnt>0){
	   ...
	   $update = "update s_de_producto_extra set pr_hospitalario=".$_POST['hospitalario'].", pr_vida=".$_POST['vida'].", pr_cesante=".$_POST['cesantia'].", pr_prima=".$_POST['prima']." where id_pr_extra='".$_POST['id_pr_extra']."' and id_ef_cia='".$_POST['id_ef_cia']."';";
	  if($conexion->query($update)===TRUE){
		  echo 1; 
	   }else{
		  echo 2; 
