		...
		if($errFlag) {
			...
			if($resultado){
				 ...
				 if($tipouser_text!='FAC' and $tipouser_text!='LOG' and $tipouser_text!='REP' and $tipouser_text!='IMP'){   
						...
						if(isset($_POST['cbOcupa'])){
							$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
							."VALUES(null, '".$id_unico."', '".$_POST['cbOcupa']."')";
							if($conexion->query($insert_permiso) === TRUE){$respta=TRUE;}else{$respta=FALSE;}
						}
						...
						if(isset($_POST['cbForpag'])){
							$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
							."VALUES(null, '".$id_unico."', '".$_POST['cbForpag']."')";
							if($conexion->query($insert_permiso) === TRUE){$respta=TRUE;}else{$respta=FALSE;}
						}
						if(isset($_POST['cbEstado'])){
							$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
							."VALUES(null, '".$id_unico."', '".$_POST['cbEstado']."')";
							if($conexion->query($insert_permiso) === TRUE){$respta=TRUE;}else{$respta=FALSE;}
						}
						if(isset($_POST['cbCertMed'])){
							$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
							."VALUES(null, '".$id_unico."', '".$_POST['cbCertMed']."')";
							if($conexion->query($insert_permiso) === TRUE){$respta=TRUE;}else{$respta=FALSE;}
						}
	...
	<script type="text/javascript">
       $(document).ready(function(e) {
		   ...
		   $('#frmUsuario').submit(function(e){
			  ...
			  miarray=[ "cbIni", "cbFor", "cbCia", "cbDes", "cbPol", "cbCreaU", "cbEmail", "cbOcupa", "cbAgen", "cbAuto", "cbTrd", "cbTrem", "cbForpag", "cbEstado", "cbCertMed", "cbDepSuc", "cbTipc", "cbTh" ];
		...
		<div class="da-panel-content">
			<form class="da-form" name="frmUsuario" action="" method="post" id="frmUsuario">';
				...
				<div class="da-form-row">
				 ...
				 <input class="child requerid" type="checkbox" name="cbOcupa" '.$cbOcupa.' '.$admiope.' value="admindatos">Administrar Ocupacion<br>
				 <input class="child requerid" type="checkbox" name="cbForpag" '.$cbForpag.' '.$admiope.' value="formapago">Administrar Forma de Pagos<br>
				 <input class="child requerid" type="checkbox" name="cbEstado" '.$cbEstado.' '.$admiope.' value="estados">Administrar Estados<br>
				 <input class="child requerid" type="checkbox" name="cbCertMed" '.$cbCertMed.' '.$admiope.' value="certificadomedico">Administrar Certificado Medico<br>
			    ...
			    if($resultado){ 
				      ...
				      if($tipouser_text!='FAC' and $tipouser_text!='LOG' and $tipouser_text!='REP' and $tipouser_text!='IMP'){
							...
							if($idusuario!=$id_usuario_sesion) {
								...
								if(isset($_POST['cbOcupa'])){
									$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
									."VALUES(null, '".$idusuario."', '".$_POST['cbOcupa']."')";
									if($conexion->query($insert_permiso) === TRUE){ $respuesta=TRUE;}else{ $respuesta=FALSE;}
								}
								if(isset($_POST['cbAgen'])){
									$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
								...
								if(isset($_POST['cbForpag'])){
									$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
									."VALUES(null, '".$idusuario."', '".$_POST['cbForpag']."')";
									if($conexion->query($insert_permiso) === TRUE){ $respuesta=TRUE;}else{ $respuesta=FALSE;}
								}
								if(isset($_POST['cbEstado'])){
									$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
									."VALUES(null, '".$idusuario."', '".$_POST['cbEstado']."')";
									if($conexion->query($insert_permiso) === TRUE){ $respuesta=TRUE;}else{ $respuesta=FALSE;}
								}
								if(isset($_POST['cbCertMed'])){
									$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
									."VALUES(null, '".$idusuario."', '".$_POST['cbCertMed']."')";
									if($conexion->query($insert_permiso) === TRUE){ $respuesta=TRUE;}else{ $respuesta=FALSE;}
								}
								if(isset($_POST['cbDepSuc'])){
									$insert_permiso = "INSERT INTO s_usuario_permiso(id_permiso, id_usuario, pagina) "
