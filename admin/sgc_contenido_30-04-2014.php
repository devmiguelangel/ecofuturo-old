						...
						<div class="da-panel collapsible">
							<div class="da-panel-header">
								<span class="da-panel-title">
									...
									<b>Entidad Financiera: '.$regief['nombre'].'</b> - Lista Contenido Home
								</span>
							</div>
	...
	if(isset($_POST['accionGuardar'])) {
		...
		if($errFlag) {
			...
			mostrar_editar_contenidohome($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion, $errArr);
			   ...
			   $update.="sl.descripcion='".$contenido."' WHERE sl.id_slider='".$idslider."' and sl.id_home = '".$idhome."' and sl.tipo='".$tipo."' and sh.id_ef='".$id_ef."';";
			   echo $update;
	...
	if(isset($_POST['accionGuardar'])) {
		...
		if($errFlag) {
			...
			mostrar_editar_contenido_nosotros($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion, $errArr);
			   ...
			   $update.="nosotros='".$contenido."' WHERE id_home = '".$idhome."' and id_ef='".$id_ef."' and producto='H';";
			   //echo $update;
...
function editar_contenido_preg_frec($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion){
	...
	if(isset($_POST['accionGuardar'])) {
			   ...
			   $update = "UPDATE s_sgc_home SET"; 
			   $update.=" preguntas_frecuentes='".$contenido."' WHERE id_home = '".$idhome."' and producto='".$producto."' and id_ef='".$id_ef."';";
