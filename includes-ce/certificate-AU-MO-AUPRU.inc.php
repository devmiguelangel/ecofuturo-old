<?php
function au_em_certificate_mo_aupru ($link, $row, $rowDt, $url, $implant, $fac, $reason = '') {
	...
	<div style="<?=$main_c_des;?>">
        ...
        <div style="<?=$header;?>">
        	<h1 style="<?=$header_h1;?>">
				...
				AL CONTRATO DE SEGURO COLECTIVO DE AUTOMOTORES PARA GARANTIAS PRENDARIAS - SERVICIO PARTICULAR CON PRIMA UNICA</h1>           
            <h4 style="<?=$header_h4;?>">
				APROBADDO SEG&Uacute;N R.A. N&deg; 248/2010 DE FECHA 31 DE MARZO DE 2010<br>
                C&Oacute;DIGO ASIGNADO 115-910520-2010 03 077-4001<br>
            </h4><br>			
        	...
        	<div style="<?=$content;?>">
            	<h2 style="<?=$h2;?>">
            		...
            		Automotores para Garantias Prendarias - Servicio Particular 
                ...
                <table cellpadding="0" cellspacing="2" border="0" style="width:750px; font-size:8px; text-align:center;">
                	<tr style="background:#829DD8;">
                        ...
                        <td colspan="2" rowspan="2" style="background:#FFF; font-size:9px; text-align:justify; width:300px;">ESCALA DE  FRANQUICIAS APLICABLES A CAMIONES: (ESTABLECIDA DE ACUERDO A MONTOS DE VALORES ASEGURADOS DECLARADOS POR EL TOMADOR).</td>
                    </tr>
				...
				<h2 style="<?=$h2;?>">Tasas aplicables sobre los montos asegurados desembolsados. La prima para cada asegurado es &uacute;nica, cobrable por una sola vez a la fecha de desembolso y considera el otorgamiento de cobertura por el plao totoal del cr&eacute;dito o hasta que el mismo haya cancelado integramente el cr&eacute;dito.</h2><br />
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%; font-size:8px; text-align:center;">
                	<tr>
                    	<td colspan="2" style="font-weight:bold;">VEHICULOS COMPRENDIDOS EN LA CLASIFICACION I (PESADO PARTICULAR)</td>
                        <td colspan="2" style="font-weight:bold;">VEHICULOS COMPRENDIDOS EN LA CLASIFICACION II (LIVIANO PARTICULAR)</td>                        
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td>1</td>
                        <td>3.336% (POR CIENTO)</td>
                        <td>1</td>
                        <td>2.887% (POR CIENTO)</td>
                    </tr>
                    <tr>
                    	<td>2</td>
                        <td>6.509% (POR CIENTO)</td>
                        <td>2</td>
                        <td>5.627% (POR CIENTO)</td>
                    </tr>
                    <tr>
                    	<td>3</td>
                        <td>9.533% (POR CIENTO)</td>
                        <td>3</td>
                        <td>8.244% (POR CIENTO)</td>
                    </tr>
                    <tr>
                    	<td>4</td>
                        <td>12.405% (POR CIENTO)</td>
                        <td>4</td>
                        <td>10.722% (POR CIENTO)</td>
                    </tr>
                    <tr>
                    	<td>5</td>
                        <td>15.958% (POR CIENTO)</td>
                        <td>5</td>
                        <td>14.174% (POR CIENTO)</td>
                    </tr>
                    <tr>
                    	<td>6</td>
                        <td>17.779% (POR CIENTO)</td>
                        <td>6</td>
                        <td>15.403% (POR CIENTO)</td>
                    </tr>
                </table>
        ...
        <div style="<?=$container_1;?>">
            <div style="<?=$content;?>"><br /><br />
                <h2 style="<?=$h2_s1;?> text-align: center;">
                    ...
                    <strong>REGLAS DEL CONTRATO DE SEGURO DE AUTOMOTORES GARANTIAS PRENDARIAS - SERVICIO PARTICULAR CON PRIMA UNICA</strong>
                </h2><br />
                <table border="0" cellpadding="0" cellspacing="0" style="text-align: justify; font-size: 8px; width: 100%;">
                    <tr>
                        <td style="width: 50%; padding: 5px;" valign="top">
                            ...
                            Desde la fecha de desembolso del Cr&eacute;dito sobre el cual se constituyo la garantia.<br />
                            ...
                            <ol style="list-style:disc; margin:10px; margin:0 0 0 -18px;">
                                ...
                                <li>En la fecha de vencimiento del contrato original del cr&eacute;dito o en la fecha de vencimiento de la renovaci&oacute;n o reprogramaci&oacute;n de plazos originales contratados por el prestatario y que haya pagado la extra prima que corresponda de acuerdo a los plazos adicionales otorgados.</li>
                                <li>En el momento en que el veh&iacute;culo materia del seguro pierde su condici&oacute;n de garantia hipotecaria del tomador por cualquier motivo distinto al anteriormente mencionado.<br>
